...
void OpenManipulatorPickandPlace::demoSequence()
{
  ...
  switch (demo_count_)
  {
    ...
    joint_angle.push_back(-0.80);
    joint_angle.push_back( 0.00);
    joint_angle.push_back( 2.40);
    setJointSpacePath(joint_name_, joint_angle, 2.0);
    demo_count_ ++;
    break;

    case 27: // wait & open the gripper
      setJointSpacePath(joint_name_, present_joint_angle_, 3.0);
    gripper_value.push_back(0.010);
    setToolControl(gripper_value);
    demo_count_ ++;
    ...
    joint_angle.push_back(-0.80);
    joint_angle.push_back( 0.00);
    joint_angle.push_back( 2.90);
    setJointSpacePath(joint_name_, joint_angle, 2.0);
    demo_count_ ++;
    break;

    case 29: // wait & open the gripper
    setJointSpacePath(joint_name_, present_joint_angle_, 3.0);
    gripper_value.push_back(0.010);
    setToolControl(gripper_value);
    demo_count_ ++;
    ...
    joint_angle.push_back(-0.80);
    joint_angle.push_back( 0.00);
    joint_angle.push_back( 3.40);
    setJointSpacePath(joint_name_, joint_angle, 2.0);
    demo_count_ ++;
    break;

    case 31: // wait & open the gripper
     setJointSpacePath(joint_name_, present_joint_angle_, 3.0);
    gripper_value.push_back(0.010);
    setToolControl(gripper_value);
    demo_count_ ++;
