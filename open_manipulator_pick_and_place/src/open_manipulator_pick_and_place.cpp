...
void OpenManipulatorPickandPlace::demoSequence()
{
  ...
  case 6: // place pose
    ...
    kinematics_position.push_back(0.132); // Y 좌표
  ...
  case 16: // place the box
    ...
    kinematics_position.push_back(0.015); // X 좌표
    kinematics_position.push_back(0.102); // Y 좌표
    kinematics_position.push_back(0.080); // Z 좌표
  ...
  case 25: // place the box
    ...
    // 수정된 위치 값
    kinematics_position.push_back(0.015); // X 좌표
    kinematics_position.push_back(0.080); // Y 좌표
    kinematics_position.push_back(0.161); // Z 좌표
